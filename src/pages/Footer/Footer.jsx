      ...
      <div className="footer-container">
        <div className="footer-top">
          ...
          <div className="footer-links">
            ...
            <div>
              ...
              <ul className="footer-list">
                <li>
                  <a href="https://github.com/kevent" className="footer-link">
                    Github
                  </a>
                </li>
              </ul>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-social">
            ...
            <a href="https://github.com/kevent" className="footer-social-icon" aria-label="GitHub page">
            ...
            <a href="https://www.instagram.com/kevent" className="footer-social-icon" aria-label="Instagram page">
